...
import pytest
from fragment_grow.models import FrontierPayload, ExecutionStatus
from fragment_grow.engine import FrontierDomainEngine
from fragment_grow.agents import RuleOfThreeFilterAgent, VectorAngleLinkerAgent, SyntheticAccessibilityAgent, FragmentGrowCoordinator
from fragment_grow.cli import main


def test_sub_agents():
    a1 = RuleOfThreeFilterAgent()
    ...
    a3 = SyntheticAccessibilityAgent()
...
def test_coordinator():
    ...
    assert "Congreve Rule of Three for FBDD" in ans or "specifications" in ans
