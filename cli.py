"""
Command Line Interface for Fragment Based Growing Agent.
"""
import argparse
import csv
import json
...
def main(argv=None):
    parser = argparse.ArgumentParser(prog="fragment-based-growing-agent", description="Fragment Based Growing Agent")
    ...
    if args.command == "audit":
        ...
        print("=" * 80)
        print(f"  FRAGMENT BASED GROWING AGENT")
    ...
    if args.command == "chat":
        ...
        print(f"\n[Fragment Based Growing Agent Supervisor]:\n{ans}\n")
        return 0
    ...
    if args.command == "serve":
        ...
        print(f"Starting Fragment Based Growing Agent API server on http://{args.host}:{args.port}")
